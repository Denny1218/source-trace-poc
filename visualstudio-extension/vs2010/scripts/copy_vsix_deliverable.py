"""Copy VS2010 VSIX to vs2010/out, visualstudio-extension/out, and 산출물/운영PC/visualstudio/."""
...
def main() -> int:
    ...
    if not src.is_file():
        ...
        return 1
    vs2010_root = Path(__file__).resolve().parents[1]
    ext_root = vs2010_root.parent
