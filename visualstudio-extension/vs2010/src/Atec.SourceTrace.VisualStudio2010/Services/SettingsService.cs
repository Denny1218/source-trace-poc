...
namespace Atec.SourceTrace.VisualStudio2010.Services
{
    public sealed class SettingsService
    {
        ...
        public SettingsService(AtecSourceTracePackage package)
        {
            _package = package;
        }
        ...
        {
            return _package.GetOptionsPage();
        }
        ...
        {
            return GetOptionsPage().EquipmentId;
        }

        public bool UseOllama()
        {
            return GetOptionsPage().UseOllama;
        }
